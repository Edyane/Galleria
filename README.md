...
<img src="https://cdn.discordapp.com/attachments/884155938985111702/1056708893927018515/galleria.png" width="450px">

> Projeto desenvolvido durante o curso rápido de SASS do Canal <i>Hora de Codar</i>.

## 🚀 Instalando SASS

Windows:

Se você usa o Node.js você pode instalar o SASS utilizando o comando NPM.
```
<npm install -g sass>
```
...
Se você usa o Homebrew você pode instalar o SASS utilizando o comando Brew.
```
